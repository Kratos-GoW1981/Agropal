                      ...
                      <div class="cart_container">
                          ...
                          <div class="cart_items">
                              ...
                              <table class="table">
                                ...
                                <tr>
                                    <th scope="col"><p><h5><b>
                                        <img src="/storage/<?php echo e($product->image); ?>"style="height:120px; width:170px;" >
                                    </b></h5></p></th>
                                    <th scope="col"><p><h2><b><?php echo e($product->name); ?></b></h2></p></th>

                                    <th scope="col"><p><h5><b>
                                        <form action="/buynow" method="POST" >
                                        <?php echo csrf_field(); ?>
                                        <input type="hidden" value="<?php echo e($product->id); ?>" name="product">
                                        <div class="quantity">
                                    ...
                                    <th scope="col"><p><h2><b><?php echo e($product->price); ?></b></h2></p></th>
                                    <th scope="col"><p><h5><b>
                                    <p class="total-price">
                                        <span id="price"><?php echo e($product->price); ?></span>
                                    </p>
                                    </b></h5></p></th>
                                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Agriculture_Online_platform(AgroPal)\resources\views/cart.blade.php ENDPATH**/ ?>
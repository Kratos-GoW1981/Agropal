...
<tr>
    <th scope="col"><p><?php echo e($message->name); ?></p></th>
      <th scope="col"><p><?php echo e($message->email); ?></p></th>
      <th scope="col"><p><?php echo e($message->phone); ?></p></th>
    <th scope="col"><p><?php echo e($message->message); ?></p></th>
    </tr>
...
</script><?php /**PATH C:\xampp\htdocs\Agriculture_Online_platform(AgroPal)\resources\views/admin/message.blade.php ENDPATH**/ ?>
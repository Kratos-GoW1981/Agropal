...
<body>
    ...
    <tr>
      ...
      <th scope="col"><h1>Quantity<hr></h1></th>
    ...
    <tr>
    <th scope="col"><p><?php echo e($order->product_id); ?></p></th>
      <th scope="col"><p><?php echo e($order->user_id); ?></p></th>
      <th scope="col"><p><?php echo e($order->id); ?></p></th>
      <th scope="col"><p><?php echo e($order->quantity); ?></p></th>
      <th scope="col"><p>
...
</script><?php /**PATH C:\xampp\htdocs\Agriculture_Online_platform(AgroPal)\resources\views/admin/orders.blade.php ENDPATH**/ ?>
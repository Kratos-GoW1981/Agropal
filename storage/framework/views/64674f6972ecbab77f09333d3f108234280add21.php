...
<body>
    ...
    <h1 style="background-color: black; height: 30px; padding:10px;"> Please verify the seller to add product </h1>
      ...
      <th scope="col"><p><?php echo e($user->companyname); ?><hr></p></th><th></th><th></th><th></th><th></th>
      <th scope="col"><p><?php echo e($user->pannumber); ?><hr></p></th><th></th><th></th><th></th><th></th>
    ...
    <th scope="col"><p><?php echo e($user->address); ?><hr></p></th><th></th><th></th><th></th><th></th>
    <th scope="col"><p><a id="login" href="/verifyseller/<?php echo e($user->id); ?>"> verify</a>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    ...
    <th scope="col"><p><?php echo e($user->id); ?><hr></p></th><th></th><th></th><th></th><th></th>
      ...
      <th scope="col"><p><?php echo e($user->number); ?><hr></p></th><th></th><th></th><th></th><th></th>
    <th scope="col"><p><?php echo e($user->address); ?><hr></p></th><th></th><th></th><th></th><th></th>
    <th scope="col"><p><a id="signup" href="/unverifyseller/<?php echo e($user->id); ?>">Un Verify</a>
    <hr></p></th><th></th><th></th><th></th><th></th>
    </tr>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    <?php endif; ?>
...
</script><?php /**PATH C:\xampp\htdocs\Agriculture_Online_platform(AgroPal)\resources\views/admin/registerseller.blade.php ENDPATH**/ ?>